...
class ExampleClass1 {
	...
	//인스턴스 변수 :각 인스턴스 마다 독립적으로 값을가지는 변수
	//반드시 인스턴스가 생성된 후에 사용할수있다
	int attribute1;
	double attribute2;
	
	//클래스 변수 : 해당 클래스로 생성돈 모든 인스턴스가 공유하는 변수
	//필드 앞에 static 키워드를 사용하여 지정
	//인스턴스 없이 클래스로 직접 접근 할 수 있음
	...
	//인스턴스가 필드를 사용하는 기능에 대해서 인스턴스 메서드를 사용(독립적인 기능)
	int method1 (int arg1) {
		// 기능 구현
		// 반환타입이 void 가 아니면 반드시 return 으로 결과값을 반환해야 함
		return arg1 * arg1;
	}
...
class TriangleMath {
	...
	//PI,getCircleArea(double)은 SRP원칙에 위배
...
public class classandobject {
	...
	public static void main(String[] args) {
		...
		iphone1.sendMessage("010-111-2222","안녕하세요");
